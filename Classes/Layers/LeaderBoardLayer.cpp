...
CCArray*  LeaderBoardLayer::get_Challenge_userlist()
{
    CCArray *arr_users;
...
void LeaderBoardLayer::save_Challenge_user(CCDictionary *user)
{
...
CCArray*  LeaderBoardLayer::get_Arcade_userlist()
{
    CCArray *arr_users;
    std::string writablePath_temp = CCFileUtils::sharedFileUtils()->getWritablePath();
...
void LeaderBoardLayer::save_Arcade_user(CCDictionary *user)
{
...
//void LeaderBoardLayer::setDelegate(LeaderBoardLayerDelegate* pDelegate)
//{
//	settingDelegte = pDelegate;
//}

#pragma  mark   COCOSBUILDER INITITIALIZATION
void LeaderBoardLayer::onNodeLoaded(cocos2d::CCNode * pNode,  cocos2d::extension::CCNodeLoader * pNodeLoader)
{
...
//    bool internet = ObjCCalls::tryIsInternetConnection();
//    if (internet){
//        HoldOnModel::shareModel()->showGameCenterLoader();
//    }
//    else{
//        ObjCCalls::openToastAlertForGameCenter();
//    }
   
}

void LeaderBoardLayer::updateChallngeModeScore()
{
    sideBarArcadeMenuItemSpr->setColor(ccc3(200, 200, 200));
    sideBarChallengeMenuItemSpr->setColor(ccc3(121, 121, 121));
...
void LeaderBoardLayer::updateArcadeModeScore()
{
...
SEL_CallFuncN LeaderBoardLayer::onResolveCCBCCCallFuncSelector(CCObject * pTarget, const char* pSelectorName)
{
//    CCB_SELECTORRESOLVER_CALLFUNC_GLUE(this, "updateChallngeModeScore", LeaderBoardLayer::updateChallngeModeScore);
//    CCB_SELECTORRESOLVER_CALLFUNC_GLUE(this, "updateArcadeModeScore", LeaderBoardLayer::updateArcadeModeScore);
    
    return NULL;
}

SEL_MenuHandler LeaderBoardLayer::onResolveCCBCCMenuItemSelector(CCObject * pTarget, const char * pSelectorName)
{
    CCB_SELECTORRESOLVER_CCMENUITEM_GLUE(this, "onHomeClicked", LeaderBoardLayer::onHomeClicked);
    
    CCB_SELECTORRESOLVER_CCMENUITEM_GLUE(this, "onsideBarChallengeMenuItemClicked", LeaderBoardLayer::onsideBarChallengeMenuItemClicked);
    CCB_SELECTORRESOLVER_CCMENUITEM_GLUE(this, "onsideBarArcadeMenuItemCicked", LeaderBoardLayer::onsideBarArcadeMenuItemCicked);
    //    CCB_SELECTORRESOLVER_CCMENUITEM_GLUE(this, "onBackGroundSoundClicked", LeaderBoardLayer::onBackGroundSoundClicked);
    
    return NULL;
}


SEL_CCControlHandler LeaderBoardLayer::onResolveCCBCCControlSelector(CCObject * pTarget, const char * pSelectorName)
{
    return NULL;
}

bool LeaderBoardLayer::onAssignCCBCustomProperty(CCObject* pTarget, const char* pMemberVariableName, cocos2d::extension::CCBValue* pCCBValue)
{
    bool bRet = false;
    return bRet;
}
bool LeaderBoardLayer::onAssignCCBMemberVariable(CCObject * pTarget, const char * pMemberVariableName, CCNode * pNode)
{
...
void LeaderBoardLayer::onHomeClicked(cocos2d::CCObject *pSender)
{
...
//void LeaderBoardLayer::on_user_clicked(cocos2d::CCObject * pSender)
//{
...
void LeaderBoardLayer::onsideBarArcadeMenuItemCicked(cocos2d::CCObject *sender)
{
...
void LeaderBoardLayer::onsideBarChallengeMenuItemClicked(cocos2d::CCObject *sender)
{
//    mAnimationManager = dynamic_cast<CCBAnimationManager *>( this->getUserObject());
//    if (mAnimationManager)
//    {
...
void LeaderBoardLayer::ccTouchesBegan(CCSet *pTouches, CCEvent *pEvent)
{
