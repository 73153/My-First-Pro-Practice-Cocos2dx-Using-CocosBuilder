...
//
    ...
    //Main Menu With Font
    CCLabelTTF *backButtonLabel = CCLabelTTF::create("Back", "Thonburi", 50);
    CCMenuItemLabel *backButton = CCMenuItemLabel::create(backButtonLabel, this, menu_selector(HelloWorld::onBackButtonPressed));
	...
	CCMenu *mainMenu = CCMenu::create(sendMailButton,
                                      ...
                                      sendMailButtonInApp,
                                      #endif
                                      sendTweetButton, backButton,postOnFBButton, NULL);
...
void HelloWorld:: onBackButtonPressed(cocos2d::CCObject *pSender)
{
