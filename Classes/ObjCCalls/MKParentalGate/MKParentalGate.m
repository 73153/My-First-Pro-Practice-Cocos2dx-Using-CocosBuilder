...
+ ( void) dismiisViewController:(UIViewController *)inViewController {
    if([inViewController isBeingPresented]==true)
    [inViewController dismissViewControllerAnimated:NO completion:nil];
}
