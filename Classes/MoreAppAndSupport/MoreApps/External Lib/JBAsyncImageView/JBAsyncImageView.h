...
#define MoreAppImageFolderPath [NSHomeDirectory() stringByAppendingFormat:@"/tmp/MoreApps"]
#define ImagePath(imageName) [MoreAppImageFolderPath stringByAppendingFormat:@"/%@",imageName]
...
// If NO, no cache will be set or used. Defaults YES.
@property(nonatomic) int isViewDisapper;
