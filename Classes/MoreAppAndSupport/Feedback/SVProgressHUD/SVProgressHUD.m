...
static const CGFloat SVProgressHUDRingNoTextRadiusIpad = 24;
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        CGFloat radius;
        if(is_iPad){
            radius = self.stringLabel.text ? SVProgressHUDRingRadius : SVProgressHUDRingNoTextRadiusIpad;
