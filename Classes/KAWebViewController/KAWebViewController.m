...
- (void)actionPressed
{
    ...
    UIActivityViewController *avc = [[UIActivityViewController alloc] initWithActivityItems:actionItems applicationActivities:@[activity]];
...
- (void)viewDidLoad
{
    ...
    [imgView setImage:[UIImage imageNamed:@"bg1"]];
