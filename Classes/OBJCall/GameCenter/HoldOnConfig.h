...
#define KArcadeBestScore             @"arcade_best_score"

#define KChallengeBestScore             @"challenge_best_score"

#define KLeaderBoardIdArcade          @"com.r3app.bricks.arcade"
#define KLeaderBoardIdMonumentChallenge @"com.r3app.bricks.monumentschallange"
